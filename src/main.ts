    ...
    mainWindow.once('ready-to-show', () => {
        ...
        if (dev) {
            installExtension(REACT_DEVELOPER_TOOLS)
                .catch((err: any) => console.log('Error loading React DevTools: ', err))
...
// todo extract update function to separate file
// const config = {
//     changeLogFile: path.join(__dirname, './resources/db/changelog/sample.changelog.xml'),
//     url: 'jdbc:sqlite:' + path.join(__dirname, './resources/db/db.sqlite'),
//     username: undefined,
//     password: undefined,
//     classpath: path.join(__dirname, './lib/sqlite-jdbc-3.30.1.jar')
// };
// function updateDb() {
